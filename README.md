...
Neste código não foram utilizadas bibliotecas de Orientação a Aspectos porém foram utilizadas técnicas para reproduzir o comportamente de forma simples. No código de C++ há a criação de uma conta bancária e foi definido um método de log através de um <i>define</i> que deve ser reproduzido em todos os métodos dessa conta bancária.
